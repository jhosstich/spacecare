...
<div class="container">
    <p class="py-4 col-md-8 mx-auto col-12">
        <br>
        <span class="sel">La basura espacial son desechos de naves espaciales abandonadas, soportes para múltiples cargas, desechos liberados intencionadamente durante las misiones espaciales.</span> Resumiendo, todos los desechos residuales de la actividad espacial.
        <br> 
        <br>
        ...
        <span class="sel">Según la NASA existen alrededor de 20.000 objetos del tamaño de una pelota de balonmano. Más de 500.000 de objetos del tamaño de una canica o más grandes.Y millones de piezas más pequeñas aún que no se pueden identificar y todos estos desechos viajan a una velocidad media de 17,500 millas por hora.  
        </span><br>
